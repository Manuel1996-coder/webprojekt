			...
			<nav class="accordion arrows">
				...
				<section class="box">
					...
					<div class="box-content">
						...
						<p style="padding-left: 1em;">
							<a hre="#">Hier</a> findest du weitere hilfreiche Informationen.
						</p>
						<p>
				...
				<section class="box">
					...
					<div class="box-content">
						...
						<p style="padding-left: 1em;">Vermutlich ist der Artikel nicht
							mehr vorhanden. Du wirst in Kürze diesbezüglch informiert.</p>
					</div>
				</section>
				...
				<section class="box">
					...
					<div class="box-content">
						...
						<p style="padding-left: 1em;">
							Ein Account ist erforderlich, um ins Portal zu gelangen. Falls du
							noch kein Account besitzt, kannst du es <a href="#">hier</a>
							erstellen.
						</p>
						<p>
						...
						<p style="padding-left: 1em;">Nach dem Einloggen, siehst du an
							der Menüliste deine Matrikelnummer. Anahnd dessen kannst du dich
							identifizieren.</p>
						<p>
							<b><font class="color">Wie funktioniert das Ratespiel?</font></b><br>
						</p>
						<p style="padding-left: 1em;">
							...
							gelassen. Aber trotzdem entwas kniffelig. Du solltest in der Lage
							sein, allegmeine Fragen zu deinem Studium beantworten zu können.
							Teste dich <a href="#">jetzt</a> selsbt
						</p>
						<p>
						...
						<p style="padding-left: 1em;">Wenn Person A ebenfalls an der
							HWG Ludwigshafen, den Studiengang Wirtschaftsinformatik studiert,
							ist sie herzlich Willkommen!</p>
					</div>
				</section>
				...
				<section class="box">
					...
					<div class="box-content">
						...
						<p style="padding-left: 1em;">lazyNerds vereinfacht dir diesen
							Aufwand. Du siehst auch direkt die Unterlagen zur Volesung,
							sobald du dich durch die einzelnen Semester durchgegangen bist.</p>
						<p>
							<b><font class="color">Kann jeder Altklausuren
									hochladen?</font></b><br>
						</p>
						<p style="padding-left: 1em;">Um den Lernerffekt zu
							vereinfachen, verzichten wir auf externe Unterlagen. Diese können
							gegen unseren Copyright-Schutz zu treffen. Aus mehreren Gründen,
							darf kein Benutzer Unterlagen hochaden.</p>
						<p>
						...
						<ol>
							...
							<li>Versuche dich nicht abzulenken und setze sich soweit wie
								möglich nach vorne.</li>
							<li>Suche dir eine gute Lerngruppe aus, von max. drei
								Personen. Die Gefahr von einer größeren Gruppe stellt sich durch
								vielen verschiedenen Meinungen und zu noch mehr Zeitdruck auf.
								Nicht zu viel, aber auch nicht zu wenige solltet ihr sein.</li>
						</ol>
					</div>
				</section>
