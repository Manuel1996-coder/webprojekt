...
1. RegAppl, RegView & RegBean erstellen (DONE)
2. LoginAppl, LoginView & LogBean erstellen (DONE)
3. Datenbank einbinden (JDBC-Folder einziehen in den Projekt) (DONE), Benutzerdaten anpassen !!!!!!
